# Copy of the same file in nixpkgs. Could be merged upstream. The difference
# is that here it can remove paths from the closure before making the cpio
# archive.
...
{ stdenv, perl, cpio, contents, compressor, prepend, ubootTools, keepStorePath
}:
...
stdenv.mkDerivation rec {
  ...
  inherit compressor prepend keepStorePath;
}
